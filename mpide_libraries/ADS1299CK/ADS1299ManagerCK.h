...
//
//  ADS1299ManagerCK.h
//  Part of the ChipKIT Library for the ADS1299 Shield
//  Created by Chip Audette, Fall 2013 Modified by Joel in Fall 2013 
//


#ifndef ____ADS1299ManagerCK__
#define ____ADS1299ManagerCK__
...
class ADS1299ManagerCK : public ADS1299CK {
  public:
    void initialize(void);                //initialize the ADS1299 controller.  Call once.  Assumes OpenBCI_V2
    void initialize(int version);         //initialize the ADS1299 controller.Set which version of OpenBCI you're using.
